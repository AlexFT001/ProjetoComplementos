...
--rua,codigoPostal,numPorta,cidade,concelho,distrito,pais.
...
EXECUTE SP_CARTAO_INSERT( 9012, 1000000000000005,  1005);
EXECUTE SP_CARTAO_INSERT( 9012, 1000000000000006,  1006);
...
EXECUTE SP_TRANSACAO_INSERT('WEB', 1000,  1002, 1000, 1005, 1000000000000005, 1000000000000000,  1005);
EXECUTE SP_TRANSACAO_INSERT('ATM', 7000,  1000, 1000, 1006, 1000000000000006, NULL,  1007);
...
--table_escolhida, id_escolhido, id_escolhido2
